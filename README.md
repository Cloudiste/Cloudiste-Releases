...
**Version actuelle : 0.64.0.** Cette mise à jour simplifie l’assistant en quatre étapes, ajoute un aperçu réel de l’accueil et maintient l’aperçu de la tuile visible pendant les réglages précis du cadrage et de la luminosité.
...
```bash
shasum -a 256 Cloudiste-0.64.0-release.apk
```
